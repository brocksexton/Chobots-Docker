package {
	...
	import com.kavalok.robotTeamStat.StatView;
	...
	public class RobotTeamStat extends WindowModule
	{
		...
		static private var _instance:RobotTeamStat;
		static public function get instance():RobotTeamStat
		{
			return _instance;	
		}
		
		public function RobotTeamStat()
		{
			_instance = this;
		}
