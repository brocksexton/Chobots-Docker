package com.kavalok.stuffCatalog.view
{
	...
	public class BugsItemView extends ItemViewBase
	{
		...
		public function BugsItemView(itemInfo:StuffSprite)
		{
		...
		private function createContent():void
		{
			...
			var info:Sprite = new BugsItemInfoSprite(StuffTypeTO(_stuffSprite.item));
		...
		{
			SpriteDecorator.decorateColor(_model, _stuffSprite.color);
		}
