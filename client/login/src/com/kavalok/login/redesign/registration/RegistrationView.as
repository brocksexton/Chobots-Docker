package com.kavalok.login.redesign.registration
{
	...
	public class RegistrationView extends WizardViewBase
	{
...
//		private static const TERMS_AND_CONDITIONS_FORMAT : String = "{0} <u><a href='http://{1}/terms.html'>{2}</a></u>";
		...
		protected var _content:McRegisterPage = new McRegisterPage();
		...
		public function RegistrationView(content:McRegisterPage)
		{
			_content = content
			super(content);
