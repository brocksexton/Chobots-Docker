package com.kavalok.utils
{
	...
	public class InteractiveCharMoving
	{
		static private var _instance:InteractiveCharMoving;
		
		static public function get instance():InteractiveCharMoving
		{
			if (!_instance)
				_instance = new InteractiveCharMoving();
		...
		public function InteractiveCharMoving()
		{
			super();
		}
