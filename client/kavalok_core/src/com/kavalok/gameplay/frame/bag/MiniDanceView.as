package com.kavalok.gameplay.frame.bag
{
	...
	public class MiniDanceView
	{
		...
		{
			var buttons:ArrayList = new ArrayList(GraphUtils.getAllChildren(_content,
				new TypeRequirement(McDanceButton)));
			...
			var customDances:Array = GraphUtils.getAllChildren(_content,
				new TypeRequirement(McCustomDanceButton));
