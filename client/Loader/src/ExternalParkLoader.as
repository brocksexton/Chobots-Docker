package
{
	...
	public dynamic class ExternalParkLoader extends MovieClip
	{
		...
		static private const MAIN_ADDRESS:String = 'http://www.chobots.de/game/';
		//static private const MAIN_ADDRESS:String = 'file:///D|/chobots/kavalok/bin/';
		
		private var _loader:Loader;
	
		public function ExternalParkLoader()
		{
		...
		{
			var swfName:String = loaderInfo.url.match(/(?<=External).+\.swf/g)[0];
