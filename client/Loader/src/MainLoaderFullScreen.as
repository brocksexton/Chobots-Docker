package
{
	...
	public class MainLoaderFullScreen extends Sprite
	{
		...
		public function MainLoaderFullScreen()
		{
			super();
			if (this.stage)
				initialize();
		...
		private function loadMain():void
		{
			...
			var mainURL:String = loaderInfo.url.replace('MainLoaderFullScreen.swf', 'Main.swf');
			if (parameters.length > 0)
				mainURL += '?' + parameters;
