package
{
	...
	public class LocationLoaderBase extends Sprite
	{
		...
		private var _moreGamesURL:String;
		private var _locale:String;
		
		public function LocationLoaderBase(loaderContent:MovieClip, moduleId:String, moreGamesURL:String = null, locale:String=null)
		{
			super();
		...
		{
			var url:String = _moreGamesURL || MORE_GAMES_URL + '?src=' + referer;
