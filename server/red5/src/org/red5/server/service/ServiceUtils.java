...
public class ServiceUtils {
  ...
  public static Object[] findMethodWithExactParameters(
      Object service, String methodName, List args) {
  ...
  /**
   * Returns (method, params) for the given service or (null, null) if not method was found. XXX use
   * ranking for method matching rather than exact type matching plus type conversion.
   *
   * @param service Service
   * @param methodName Method name
   * @return Method/params pairs
   ...
   */
  public static Object[] findMethodWithExactParameters(
      Object service, String methodName, Object[] args) {
   ...
   * @param service Service
   */
  public static Object[] findMethodWithListParameters(
      Object service, String methodName, List args) {
    Object[] arguments = new Object[args.size()];
    for (int i = 0; i < args.size(); i++) {
      arguments[i] = args.get(i);
