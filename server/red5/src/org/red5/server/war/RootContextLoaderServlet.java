...
/**
 * Entry point from which the server config file is loaded while running within a J2EE application
 * container.
 *
 * <p>This listener should be registered after Log4jConfigListener in web.xml, if the latter is
 * used.
 *
...
public class RootContextLoaderServlet extends ContextLoaderListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    try {
      ...
      applicationContext =
          (ConfigurableWebApplicationContext) loader.initWebApplicationContext(servletContext);
      ...
      servletContext.setAttribute(
          "remoting.codec.factory", parentFactory.getBean("remotingCodecFactory"));
      ...
      IRemotableList remote =
          (IRemotableList) Naming.lookup("rmi://localhost:" + rmiPort + "/subContextList");
      ...
      timer = new Timer("RootContextLoaderServlet");
