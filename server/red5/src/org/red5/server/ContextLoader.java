...
public class ContextLoader implements ApplicationContextAware {
  ...
  /** Context map */
  protected HashMap<String, ApplicationContext> contextMap =
  ...
  /**
   * Loads context (Red5 application) and stores it in context map, then adds it's beans to parent
   * (that is, Red5)
   *
  ...
  protected void loadContext(String name, String config) {
    ...
    ApplicationContext context =
        new FileSystemXmlApplicationContext(new String[] {config}, parentContext);
