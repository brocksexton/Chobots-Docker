...
/**
 * Base abstract class for connections. Adds connection specific functionality like work with
 * clients to AttributeStore.
 */
public abstract class BaseConnection extends AttributeStore implements IConnection {
   ...
   *
   * @see <a href='http://livedocs.adobe.com/fms/2/docs/00000570.html'>NetConnection in Flash Media
   *     Server docs (external)</a>
   */
