...
public abstract class AbstractScopeAdapter implements IScopeHandler {
  /**
   * Can start flag. <code>true</code> if scope is ready to be activated, <code>false</code>
   * otherwise
   */
  private boolean canStart = true;
  /**
   * Can connect flag. <code>true</code> if connections to scope are allowed, <code>false</code>
   * otherwise
   */
  ...
  /**
   * Can call service flag. <code>true</code> if remote service calls are allowed for the scope,
   * <code>false</code> otherwise
   */
  private boolean canCallService = true;
  /**
   * Can add child scope flag. <code>true</code> if scope is allowed to add child scopes, <code>
   * false</code> otherwise
   */
  private boolean canAddChildScope = true;

  /**
   * Can handle event flag. <code>true</code> if events handling is allowed, <code>false</code>
   * otherwise
   */
   ...
   *
   * @param canStart <code>true</code> if scope is ready to be activated, <code>false</code>
   *     otherwise
   */
   ...
   *
   * @param canCallService <code>true</code> if remote service calls are allowed for the scope,
   *     <code>false</code> otherwise
   */
   ...
   *
   * @param canConnect <code>true</code> if connections to scope are allowed, <code>false</code>
   *     otherwise
   */
