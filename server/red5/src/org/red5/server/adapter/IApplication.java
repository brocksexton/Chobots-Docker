...
/**
 * IApplication provides lifecycle methods that most communication applications will use. This
 * interface defines the methods that are called by Red5 through an applications life.
 *
...
public interface IApplication {
   ...
   *
   * @param conn Connection object used to provide basic connection methods. See {@link
   ...
   * @return <code>true</code> accepts the client, <code>false</code> rejects it
   */
