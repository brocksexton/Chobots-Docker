...
public class XmlRpcScopeStatistics {
  ...
  /**
   * Return an object that can be serialized through XML-RPC. Inspired by "Reflective XML-RPC" by
   * "Stephan Maier".
   *
   * @param value
   * @return
  ...
  public Map<String, Object> getSharedObjects(String path) {
    ...
    ISharedObjectService service =
        (ISharedObjectService) ScopeUtils.getScopeService(scope, ISharedObjectService.class, false);
    if (service == null) {
