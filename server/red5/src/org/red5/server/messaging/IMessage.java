 ...
 *
 * <p>Structure of messages is designed according to JMS Message interface. Message is composed of
 * header and body. Header contains commonly used pre-defined headers and extensible headers.
 *
 * <p>Each message has correlation ID that is never used so far and is subject to be removed in
 * future.
 *
 * <p>Message has type and number of properties.
 *
