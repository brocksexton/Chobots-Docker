...
/**
 * Abstract pipe that books providers/consumers and listeners. Aim to ease the implementation of
 * concrete pipes. For more information on what pipe is, see IPipe interface documentation.
 *
...
public abstract class AbstractPipe implements IPipe {
  ...
  protected volatile List<IPipeConnectionListener> listeners =
      new CopyOnWriteArrayList<IPipeConnectionListener>();

  /**
   * Connect consumer to this pipe. Doesn't allow to connect one consumer twice. Does register event
  ...
  public boolean subscribe(IConsumer consumer, Map paramMap) {
    // Pipe is possibly used by dozens of Threads at once (like many subscribers for one server
    // stream)
