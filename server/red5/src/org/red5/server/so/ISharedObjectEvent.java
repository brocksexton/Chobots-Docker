...
public interface ISharedObjectEvent {
   ...
   *
   * <p>Depending on the type this contains:
   *
   * <ul>
   *   <li>the attribute name to set for SET_ATTRIBUTE
   *   <li>the attribute name to delete for DELETE_ATTRIBUTE
   *   <li>the handler name to call for SEND_MESSAGE
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>the attribute value to set for SET_ATTRIBUTE
   *   <li>a list of parameters to pass to the handler for SEND_MESSAGE
   * </ul>
   *
