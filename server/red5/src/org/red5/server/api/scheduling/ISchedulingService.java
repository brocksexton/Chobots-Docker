...
/**
 * Service that supports periodic execution of jobs, adding, removing and getting their name as
 * list.
 *
...
public interface ISchedulingService extends IScopeService {
  ...
  /**
   * Schedule a job for single execution in the future. Please note that the jobs are not saved if
  ...
  /**
   * Schedule a job for single execution at a given date. Please note that the jobs are not saved if
   * Red5 is restarted in the meantime.
   *
