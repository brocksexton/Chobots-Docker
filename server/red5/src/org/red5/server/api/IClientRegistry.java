...
/**
 * Provides a registry of client objects. You can lookup a client by its client id / session id
 * using lookupClient method. This interface implementations also create new client objects from
 * given params, usually passed from client-side Flex/Flash application upon initial connection.
 *
