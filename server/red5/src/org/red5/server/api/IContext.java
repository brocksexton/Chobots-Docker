...
/**
 * The current context, this object basically wraps the Spring context or in the case of the .Net
 * version, any similar system.
 */
public interface IContext extends ResourcePatternResolver {
  ...
  /**
   * Returns service invoker object. Service invokers are objects that make service calls to client
   * side NetConnection objects.
   *
  ...
  /**
   * Returns persistence store object, a storage for persistent objects like persistent
   * SharedObjects.
   *
  ...
  /**
   * Returns scope handler (object that handle all actions related to the scope) by path. See {@link
   * IScopeHandler} for details.
   *
  ...
  /**
   * Returns scope by path. You can think of IScope as of tree items, used to separate context and
   * resources between users. See {@link IScope} for more details.
   *
  ...
  /**
   * Returns scope by path from given root. You can think of IScope as of tree items, used to
   * separate context and resources between users. See {@link IScope} for more details.
   *
