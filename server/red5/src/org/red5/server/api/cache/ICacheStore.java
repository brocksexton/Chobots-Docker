 ...
 * <p>
 *
 * @see <a href="http://www-128.ibm.com/developerworks/java/library/j-jtp01246.html">Soft references
 *     provide for quick-and-dirty caching</a>
 * @see <a href="http://java.sun.com/developer/technicalArticles/ALT/RefObj/">Reference Objects and
 *     Garbage Collection</a>
 * @see <a href="http://www.onjava.com/pub/a/onjava/2002/10/02/javanio.html?page=3">Top Ten New
 *     Things You Can Do with NIO</a>
 * @see <a
 *     href="http://csci.csusb.edu/turner/archive/courses/aiit2004/proxy_cache_solution.html">http://csci.csusb.edu/turner/archive/courses/aiit2004/proxy_cache_solution.html</a>
...
public interface ICacheStore {
  ...
  /**
   * Offer an object to the cache with an associated key. If the named object exists in cache, it
