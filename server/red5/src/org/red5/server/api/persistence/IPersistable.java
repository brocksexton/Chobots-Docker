 ...
 *
 * <p>Every object that complies to this interface must provide either a constructor that takes an
 * input stream as only parameter or an empty constructor so it can be loaded from the persistence
 * store.
 *
 * <p>However this is not required for objects that are created by the application and initialized
 * afterwards.
 *
...
public interface IPersistable {
  ...
  /**
   * Returns <code>true</code> if the object is persistent, <code>false</code> otherwise.
   *
