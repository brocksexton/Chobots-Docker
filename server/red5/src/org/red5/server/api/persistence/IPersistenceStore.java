...
public interface IPersistenceStore {
  ...
  /**
   * Load a persistent object with the given name. The object must provide either a constructor that
   * takes an input stream as only parameter or an empty constructor so it can be loaded from the
   * persistence store.
   *
   * @param name the name of the object to load
   * @return The loaded object or <code>null</code> if no such object was found
   */
   ...
   * @return <code>true</code> if object was persisted and thus can be removed, <code>false</code>
   *     otherwise
   */
  ...
  /**
   * Notify store that it's being closed. This allows the store to write any pending objects to
   * disk.
   */
