...
public interface IPendingServiceCall extends IServiceCall {
  ...
  /**
   * Registers callback object usually represented as an anonymous class instance that implements
   * IPendingServiceCallback interface.
   *
  ...
  /**
   * Unregisters callback object usually represented as an anonymous class instance that implements
   * IPendingServiceCallback interface.
   *
   * @param callback Callback object
   */
  ...
  /**
   * Returns list of callback objects, usually callback object represented as an anonymous class
