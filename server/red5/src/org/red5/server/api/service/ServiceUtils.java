...
public class ServiceUtils {
   ...
   * @return <code>true</code> if the connection supports method calls, otherwise <code>false</code>
   */
  public static boolean invokeOnConnection(
   ...
   */
  public static boolean invokeOnConnection(
      IConnection conn, String method, Object[] params, IPendingServiceCallback callback) {
   ...
   * @param callback object to notify when result is received
   */
  public static void invokeOnAllConnections(
      String method, Object[] params, IPendingServiceCallback callback) {
   ...
   */
  public static void invokeOnAllConnections(
      IScope scope, String method, Object[] params, IPendingServiceCallback callback) {
   ...
   * @param callback object to notify when result is received
   */
  public static void invokeOnClient(
      IClient client,
      IScope scope,
      String method,
      Object[] params,
