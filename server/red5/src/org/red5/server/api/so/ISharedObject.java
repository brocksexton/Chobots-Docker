...
public interface ISharedObject
   ...
   * with a call to <code>release</code> so the SO isn't held forever.
   *
   * <p>This method basically is a noop for persistent SOs as their data is stored and they can be
