 ...
 *
 * <p>This class uses a thread local, and will be setup by the service invoker.
 *
 * <p>The code below shows various uses.
 *
 * <p><code>
...
public final class Red5 {
  ...
  /**
   * Current connection thread. Each connection of Red5 application runs in a separate thread. This
   * is thread object associated with the current connection.
   */
  ...
  public static final String VERSION = "Modified Red5 Server for Kavalok ~0.7.0 Revision: 2677";
  ...
  /**
   * Create a new Red5 object using the connection local to the current thread A bit of magic that
   * lets you access the red5 scope from anywhere
   */
  public Red5() {
  ...
  /**
   * Get the connection associated with the current thread. This method allows you to get connection
   * object local to current thread. When you need to get a connection associated with event handler
   * and so forth, this method provides you with it.
   *
