...
/**
 * This class is the only IBandwidthConfigure implementation provided in 0.6. It's a kind of
 * ValueObject (item with a set of values that just stores data) that is used to configure Red5
 * application bandwidth settings.
 *
 * <p>Note: To configure the connection's bandwidth, you should use the implementation of {@link
 * IConnectionBWConfig} instead.
 *
