...
public interface IStreamAwareScopeHandler extends IScopeHandler {
  /**
   * A broadcast stream starts being published. This will be called when the first video packet has
   * been received.
   *
   * @param stream
   */
  ...
  /**
   * A broadcast stream starts being recorded. This will be called when the first video packet has
   * been received.
   *
   * @param stream
   */
