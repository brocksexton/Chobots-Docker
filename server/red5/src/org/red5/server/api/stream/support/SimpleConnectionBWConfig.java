...
public class SimpleConnectionBWConfig extends SimpleBandwidthConfigure
  ...
  public long getDownstreamBandwidth() {
    ...
    if (channelBandwidth[IBandwidthConfigure.OVERALL_CHANNEL] >= 0) {
      ...
      long bw = 0;
      if (channelBandwidth[IBandwidthConfigure.AUDIO_CHANNEL] < 0
          || channelBandwidth[IBandwidthConfigure.VIDEO_CHANNEL] < 0) {
        bw = -1;
      } else {
        bw =
            channelBandwidth[IBandwidthConfigure.AUDIO_CHANNEL]
                + channelBandwidth[IBandwidthConfigure.VIDEO_CHANNEL];
      }
