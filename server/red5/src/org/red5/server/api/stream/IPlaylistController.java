...
public interface IPlaylistController {
   ...
   * @param itemIndex The current item index. <tt>-1</tt> indicates to retrieve the first item for
   *     play.
   ...
   *
   * @param playlist The related play list.
   * @param itemIndex The current item index. <tt>IPlaylist.itemSize</tt> indicated to retrieve the
   *     last item for play.
