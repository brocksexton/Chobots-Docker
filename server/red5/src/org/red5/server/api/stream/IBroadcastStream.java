...
/**
 * A broadcast stream is a stream source to be subscribed by clients. To subscribe a stream from
 * your client Flash application use NetStream.play method. Broadcast stream can be saved at
 * server-side.
 *
...
public interface IBroadcastStream extends IStream {
   ...
   *
   * @return The filename relative to the scope or <code>null</code> if the stream is not being
   *     saved.
   */
   ...
   * <code>NetStream.publish</code> on client side in SWF.
   *
