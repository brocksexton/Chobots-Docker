...
/**
 * Statistics methods for Red5. They can be used to poll for updates of given elements inside the
 * server. Statistics data will be stored as properties of different shared objects.
 *
 * <p>Use <code>getScopeStatisticsSO</code> and <code>getSharedObjectStatisticsSO</code> to get
 * these shared objects. The property names are <code>scopeName</code> for scope attributes and
 * <code>scopeName|sharedObjectName</code> for shared object attributes. Each property holds a Map
 * containing key/value mappings of the corresponding attributes.
 *
 * <p>Sometime in the future, the updates on the shared objects will be done automatically so a
 * client doesn't need to poll for them.
 *
