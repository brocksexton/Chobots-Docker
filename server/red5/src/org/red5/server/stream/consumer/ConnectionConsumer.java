...
public class ConnectionConsumer implements IPushableConsumer, IPipeConnectionListener {
  ...
  public ConnectionConsumer(
      RTMPConnection conn, int videoChannel, int audioChannel, int dataChannel) {
    this.conn = conn;
  ...
  public void onOOBControlMessage(
    ...
    if ("pendingCount".equals(oobCtrlMsg.getServiceName())) {
      ...
      oobCtrlMsg.setResult(
          new Long[] {conn.getWrittenBytes() - conn.getClientBytesRead(), maxStream / 2});
