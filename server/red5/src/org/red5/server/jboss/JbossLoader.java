 ...
 */
public class JbossLoader implements ApplicationContextAware {

  /** We store the application context in a ThreadLocal so we can access it later */
  protected static ThreadLocal<ApplicationContext> applicationContext =
  ...
  public void start() {
    ...
    try {
      ...
      ClassPathXmlApplicationContext appCtx =
          new ClassPathXmlApplicationContext(configRoot + "beanRefContext.xml");
  ...
  public void stop() {
    ...
    try {
      ...
      FileSystemXmlApplicationContext appContext =
          (FileSystemXmlApplicationContext) getApplicationContext();
