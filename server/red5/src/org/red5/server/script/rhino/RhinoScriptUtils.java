...
public class RhinoScriptUtils {
  ...
  // Javascript wrapper
  private static final String jsWrapper =
      "function Wrapper(obj){return new JSAdapter(){ __has__ : function(name){return true;}, __get__ : function(name){if(name in obj){return obj[name];}else if(typeof(obj['doesNotUnderstand']) == 'function'){return function(){return obj.doesNotUnderstand(name, arguments);}}else{return undefined;}}};}";

  /**
   * Create a new Rhino-scripted object from the given script source.
   *
   * @param scriptSource the script source text
   * @param interfaces the interfaces that the scripted Java object is supposed to implement
   * @param extendedClass
   * @return the scripted Java object
   * @throws ScriptCompilationException in case of Rhino parsing failure
   * @throws java.io.IOException
   */
  public static Object createRhinoObject(
      String scriptSource, Class[] interfaces, Class extendedClass)
  ...
  /**
   * Uses a regex to get the first "function" name, this name is used to create an instance of the
   * javascript object.
   *
   * @param scriptSource
   * @return
