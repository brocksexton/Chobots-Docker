...
/**
 * Web scope is special scope that is aware of servlet context and represents scope of Red5
 * application in servlet container (or application server) like Tomcat, Jetty or JBoss.
 *
 * <p>Web scope is aware of virtual hosts configuration for Red5 application and is the first scope
 * that instantiated after Red5 application gets started.
 *
 * <p>Then it loads virtual hosts configuration, adds mappings of paths to global scope that is
 * injected thru Spring IoC context file and runs initialization process.
 *
 * <p>Red5 server implementation instance and ServletContext are injected as well.
 */
