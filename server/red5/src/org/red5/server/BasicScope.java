...
/**
 * Generalizations of one of main Red5 object types, Scope. Basic scope is a persistable attribute
 * store with event handling functionality
 *
...
public abstract class BasicScope extends PersistableAttributeStore implements IBasicScope {
   ...
   * @param name Scope name. Used to identify scopes in application, must be unique among scopes of
   *     one level
  ...
  /**
   * Notifies listeners on event. Current implementation is empty. To be implemented in subclass
   * realization
   *
