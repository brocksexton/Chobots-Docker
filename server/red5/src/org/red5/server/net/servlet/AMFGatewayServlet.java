...
public class AMFGatewayServlet extends HttpServlet {
  ...
  protected RemotingPacket decodeRequest(HttpServletRequest req) throws Exception {
    ...
    RemotingPacket packet =
        (RemotingPacket) codecFactory.getSimpleDecoder().decode(null, reqBuffer);
   ...
   */
  protected boolean handleRemotingPacket(
      HttpServletRequest req, IContext context, IScope scope, RemotingPacket message) {
