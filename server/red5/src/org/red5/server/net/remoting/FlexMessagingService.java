...
public class FlexMessagingService {
   ...
   * @return
   */
  public static ErrorMessage returnError(
      AbstractMessage request, String faultCode, String faultString, String faultDetail) {
   ...
   */
  public static ErrorMessage returnError(
      AbstractMessage request, String faultCode, String faultString, Throwable error) {
   ...
   *
   * @see <a
   *     href="http://livedocs.adobe.com/flex/2/langref/mx/rpc/remoting/mxml/RemoteObject.html">Adobe
   *     Livedocs (external)</a>
   * @param msg
   * @return
   */
  public AsyncMessage handleRequest(RemotingMessage msg) {
    ...
    if (endpoint == null) {
      ...
      return returnError(
          msg,
          "Server.Invoke.Error",
          "Endpoint " + msg.destination + " doesn't exist.",
          "Endpoint " + msg.destination + " doesn't exist.");
    }
  ...
  /**
   * This is mandatory for client built from Flex 3 or later, or client will hang with concurrent
   * accesses.
   *
   * @param msg
   */
