...
public class RemotingClient {
  ...
  public Object invokeMethod(String method, Object[] params) {
    ...
    post.setRequestEntity(
        new InputStreamRequestEntity(data.asInputStream(), data.limit(), CONTENT_TYPE));
    try {
  ...
  public void invokeMethod(String method, Object[] methodParams, IRemotingCallback callback) {
    ...
    try {
      ...
      Class<?>[] paramTypes =
          new Class[] {RemotingClient.class, String.class, Object[].class, IRemotingCallback.class};
  ...
  public static class RemotingWorker {
    ...
    public void executeTask(
        RemotingClient client, String method, Object[] params, IRemotingCallback callback) {
      try {
