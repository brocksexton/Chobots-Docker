...
public interface SimpleProtocolDecoder {
   ...
   * @return one of three possible values. null : the object could not be decoded, or some data was
   *     skipped, just continue. ProtocolState : the decoder was unable to decode the whole object,
   *     refer to the protocol state Object : something was decoded, continue
