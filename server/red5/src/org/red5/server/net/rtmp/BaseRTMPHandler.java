...
public abstract class BaseRTMPHandler
  ...
  /** {@inheritDoc} */
  public void messageReceived(RTMPConnection conn, ProtocolState state, Object in)
      throws Exception {
    ThreadMonitorServices.setJobDetails(
        "BaseRTMPHandler.messageReceived(RTMPConnection conn {0}, ProtocolState state {1}, Object in {2}): ",
        conn, state, in);
   ...
   */
  protected abstract void onChunkSize(
   ...
   */
  protected void onStreamBytesRead(
      RTMPConnection conn, Channel channel, Header source, BytesRead streamBytesRead) {
   ...
   */
  protected abstract void onSharedObject(
