...
/**
 * A pseudo-connection on Origin that represents a client on Edge. The connection is created behind
 * a MRTMP connection so no handshake job or keep-alive job is necessary. No raw byte data write is
 * needed either.
 *
