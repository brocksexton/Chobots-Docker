...
public class Server implements IServer, ApplicationContextAware {
  ...
  protected ConcurrentMap<String, IGlobalScope> globals =
      new ConcurrentHashMap<String, IGlobalScope>();
  ...
  public Set<IConnectionListener> connectionListeners =
      new CopyOnWriteArraySet<IConnectionListener>();
  ...
  /**
   * Return scope key. Scope key consists of host name concatenated with context path by slash
   * symbol
   *
  ...
  public boolean addMapping(String hostName, String contextPath, String globalName) {
    log.info(
        "Add mapping global: " + globalName + " host: " + hostName + " context: " + contextPath);
