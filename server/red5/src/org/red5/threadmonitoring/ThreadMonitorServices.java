...
/**
 * ThreadMonitorServices class provides information about what threads currently are doing. <br>
 * It also has a feature of logging structure log entries in thread in details log <br>
 * the usage is simple :<br>
 * start(&quot;my thread&quot;); ... setJobType(&quot;my type&quot;); setJobDetails(&quot;starting
 * init&quot;); ... setJobDetails(&quot;the action part 1&quot;); ... startJobSubDetails(); ...
 * startJobSubDetails(); stopJobSubDetails(&quot;some small part of sub action&quot;); ...
 * startJobSubDetails(); stopJobSubDetails(&quot;some other small part of sub action&quot;); ...
 * stopJobSubDetails(&quot;the end of sub action&quot;); ... setJobDetails(&quot;the action part
 * 2&quot;); ... finish(); is permited <br>
 * each of thouse start/stop pairs will be stored as loged in structurical way <br>
 * here is the tempalte <br>
 * INFO: job :[JOB TYPE]: [JOB NAME] time.[jobSubDetails] time.[jobDetails] the example how it will
 * look in our code Nov 12, 2003 12:31:38 AM com.componence.utils.logging.Logger log INFO: job :my
 * type:my thread 20.starting init 25.some small part of sub action 20.some other small part of sub
 * action 119.the end of sub action 159.the action part 1 finished took.237
 */
public class ThreadMonitorServices {
  ...
  /** Sets all thread information (jobs, job details and job subdetails) to be loggable. */
  ...
  /**
   * Sets all thread information to unloggable state and resets all log buffers of monitored
   * threads.
   */
  ...
  /**
   * Creates new <code>ThreadMonitorModel</code> instance with specified <code>job</code> parameter
   * and sets it as current monitored model for current thread. If another job is already started it
   * is set as a parent for the newly created job.
   *
   * @param job job to create <code>ThreadMonitorModel</code> instance with
   */
   ...
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param job new job name for currently monitored thread
   */
  ...
  /**
   * Sets new job details. If there are old job details, stores their log info in a log buffer for
   * currently monitored thread.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param details details for currently monitored thread to be logged
   */
  ...
  /**
   * Sets new job details. If there are old job details, stores their log info in a log buffer for
   * currently monitored thread. Uses <code>params</code> to format details message with {@link
   ...
   *
   * @param details details for currently monitored thread to be logged
   * @param params arguments used to format details message
   */
  ...
  /**
   * Sets new job details. If there are old job details, stores their log info in a log buffer for
   * currently monitored thread. Uses given parameter to format details message with {@link
   * java.text.MessageFormat#format(java.lang.String, java.lang.Object[])
   * MessageFormat#format(String, Object[])}.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param details details for currently monitored thread to be logged
   * @param param0 argument used to format details message
   */
  ...
  /**
   * Sets new job details. If there are old job details, stores their log info in a log buffer for
   * currently monitored thread. Uses given parameters to format details message with {@link
   * java.text.MessageFormat#format(java.lang.String, java.lang.Object[])
   * MessageFormat#format(String, Object[])}.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   ...
   * @param details details for currently monitored thread to be logged
   * @param param0 argument used to format details message
   * @param param1 argument used to format details message
   */
   ...
   * @param param0 argument used to format details message
   * @param param1 argument used to format details message
   * @param param2 argument used to format details message
   */
   ...
   * @param param1 argument used to format details message
   * @param param2 argument used to format details message
   * @param param3 argument used to format details message
   */
  public static void setJobDetails(
      String details, Object param0, Object param1, Object param2, Object param3) {
   ...
   * @param param2 argument used to format details message
   * @param param3 argument used to format details message
   * @param param4 argument used to format details message
   */
  public static void setJobDetails(
      String details, Object param0, Object param1, Object param2, Object param3, Object param4) {
   ...
   * For each start operation, stopJobSubDetails(String subDetails) should be called.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   */
  ...
  /**
   * Stores the subDetails log info in a log buffer for currently monitored thread.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param subDetails sub details for current thread to be logged
   */
  ...
  /**
   * Stores the subDetails log info in a log buffer for currently monitored thread. Uses given
   * parameters to format subdetails message with {@link
   * java.text.MessageFormat#format(java.lang.String, java.lang.Object[])
   * MessageFormat#format(String, Object[])}.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param subDetails sub details for current thread to be logged
   * @param params to format sub details message
   */
  ...
  /**
   * Stores the subDetails log info in a log buffer for currently monitored thread. Uses given
   * parameter to format sub details message with {@link
   * java.text.MessageFormat#format(java.lang.String, java.lang.Object[])
   * MessageFormat#format(String, Object[])}.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param subDetails sub details for current thread to be logged
   * @param param0 argument used to format sub details message
   */
  ...
  /**
   * Stores the subDetails log info in a log buffer for currently monitored thread. Uses given
   * parameters to format sub details message with {@link
   * java.text.MessageFormat#format(java.lang.String, java.lang.Object[])
   * MessageFormat#format(String, Object[])}.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   ...
   * @param subDetails sub details for current thread to be logged
   * @param param0 argument used to format sub details message
   * @param param1 argument used to format sub details message
   */
   ...
   * @param param0 argument used to format sub details message
   * @param param1 argument used to format sub details message
   * @param param2 argument used to format sub details message
   */
  public static void stopJobSubDetails(
      String subDetails, Object param0, Object param1, Object param2) {
   ...
   * @param param1 argument used to format sub details message
   * @param param2 argument used to format sub details message
   * @param param3 argument used to format sub details message
   */
  public static void stopJobSubDetails(
      String subDetails, Object param0, Object param1, Object param2, Object param3) {
   ...
   * @param param2 argument used to format sub details message
   * @param param3 argument used to format sub details message
   * @param param4 argument used to format sub details message
   */
  public static void stopJobSubDetails(
      String subDetails,
      Object param0,
   ...
   * <p>Note: Does nothing if there is no currently monitored thread.
   *
   * @param type type of current job to be set
   */
   ...
   *
   * @return type of current job, or <code>null</code> if there is no currently monitored thread
   */
  ...
  /**
   * Logs currently monitored thread information and releases it (stops monitoring). If there was
   * another job set previously, it is set as current job of this thread.
   *
   * <p>Note: Does nothing if there is no currently monitored thread.
   */
  public static void finish() {
    ...
    try {
      ...
      System.err.println(
          "ThreadMonitorService.finish, oops - something went terribly wrong in the finish method");
      t.printStackTrace();
    }
  ...
  /**
   * Returns a list of <code>ThradMonitorModel</code> details of active threads.
   *
  ...
  private static void logFinish(ThreadMonitorModel job) {
    if (LOG) {
      ...
      if (job != null && (job.getType() != null || job.getJob() != null)) {
        ...
        if (timeTook < minimalThreadTimeToLog) return;
        StringBuffer log = job.getLog();
