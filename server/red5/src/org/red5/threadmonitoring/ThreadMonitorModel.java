...
/**
 * Model for storing and retrieving information about currently monitored thread's activity. <br>
 */
public class ThreadMonitorModel {
  ...
  /**
   * Constructs <code>ThreadMonitorModel</code> instance with specified job name. StartTime is set
   * to current time value. Thread is set to current thread value.
   *
   * @param job job name to create model with
   */
