...
public class Logger extends java.util.logging.Logger {
  ...
  /**
   * Constructs a Logger with the specified name. Registers the newly created Logger with <code>
   * @link java.util.logging.LogManager</code>.
   *
   * @param name A name of the logger. It should be a dot-separated name; it should be normally
   ...
   *
   * @param infoMessage a message to log
   * @param arguments array of parameters for the message
   */
   ...
   *
   * @param warningMessage a message to log
   * @param arguments array of parameters for the message
   */
  ...
  /**
   * Logs a message, with associated Throwable information and logging level <tt>WARNING</tt>
   *
   * @param warningMessage a message to log
  ...
  /**
   * Formats and logs a message, with associated Throwable information and logging level
   * <tt>WARNING</tt>
   *
   * @param warningMessage a message to log
   * @param arguments array of parameters for the message
  ...
  /**
   * Logs a message, with associated Throwable information and logging level <tt>SEVERE</tt>
   *
   * @param severeMessage a message to log
   * @param th Throwable, associated with log message.
   */
   ...
   * <tt>SEVERE</tt>
   *
   * @param severeMessage message to log
   * @param arguments array of parameters to the message
   * @param thrown Throwable associated with log message
   */
   ...
   * Logs a message.
   *
   * <p>Formats a message, using {@link java.text.MessageFormat#format(String, Object[])
   * MessageFormat.format()}, and then logs it with {@link java.util.logging.Logger#log(Level,
   * String) Logger.log()}.
   *
