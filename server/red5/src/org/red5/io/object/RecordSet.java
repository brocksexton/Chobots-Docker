...
/**
 * Read only RecordSet object that might be received through remoting calls. There are 3 types of
 * data fetching:
 *
 * <ul>
 *   <li>On demand (used by default)
 *   <li>Fetch all at once
 *   <li>Page-by-page fetching
 * </ul>
 *
 * <p>For last mode, use <tt>page size</tt> property to specify maximum number of rows on one page
 *
...
public class RecordSet {
  ...
  /**
   * Set the mode for fetching paged results with given max page size and number of prefetched
   * pages.
   *
   * @param mode Mode for fetching of results
   * @param pageSize Max page size
  ...
  /**
   * Return a specified item from the recordset. If the item is not available yet, it will be
