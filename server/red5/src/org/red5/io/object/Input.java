...
/**
 * Interface for Input which defines the contract methods which are to be implemented. Input object
 * provides ways to read primitives, complex object and object references from byte buffer.
 *
...
public interface Input {
  ...
  /**
   * Read an array. This can result in a List or Map being deserialized depending on the array type
   * found.
   *
   * @return array
   */
  ...
  /**
   * Read a map containing key - value pairs. This can result in a List or Map being deserialized
   * depending on the map type found.
   *
   * @return Map
   */
