...
/**
 * The core datatypes supported by red5, I have left out undefined (this is up for debate). If a
 * codec returns one of these datatypes its handled by the base serializer.
 *
...
public class DataTypes {
   ...
   *
   * @param type Data type as byte
   * @return boolean <code>true</code> if data type is complex (non-primitive), <code>false</code>
   *     otherwise
   */
