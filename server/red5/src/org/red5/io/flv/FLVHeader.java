...
public class FLVHeader {
   ...
   *
   * @return boolean <code>true</code> if this FLV header contains audio data, <code>false</code>
   *     otherwise
   */
   ...
   *
   * @param flagAudio <code>true</code> if this FLV header contains audio data, <code>false</code>
   *     otherwise
   */
   ...
   *
   * @return boolean <code>true</code> if this FLV header contains vide data, <code>false</code>
   *     otherwise
   */
   ...
   * Sets the audioflag on whether this data contains audio
   *
   * @param type_flags_video <code>true</code> if this FLV header contains video data, <code>false
   *     </code> otherwise
   */
