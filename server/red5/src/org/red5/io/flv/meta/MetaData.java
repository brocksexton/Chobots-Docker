 ...
 *     <p>Example:
 *     <p>// private boolean canSeekToEnd = true; // private int videocodecid = 4; // private int
 *     framerate = 15; // private int videodatarate = 600; // private int height; // private int
 *     width = 320; // private double duration = 7.347;
 */
public class MetaData<K, V> extends HashMap<String, Object> implements IMetaData {
