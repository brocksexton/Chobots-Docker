...
/**
 * A Reader is used to read the contents of a FLV file. NOTE: This class is not implemented as
 * threading-safe. The caller should make sure the threading-safety.
 *
...
public class FLVReader implements IoConstants, ITagReader, IKeyFrameDataAnalyzer {
   ...
   * @param generateMetadata <code>true</code> if metadata generation required, <code>false</code>
   *     otherwise
   */
  ...
  /**
   * Put the current position to pos. The caller must ensure the pos is a valid one (eg. not sit in
