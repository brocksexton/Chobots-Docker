...
public interface IStreamableFileService {
  ...
  /**
   * Prepair given string to conform filename requirements, for example, add extension to the end if
   * missing.
   *
   ...
   * @return <code>true</code> if file exist and has valid extension, <code>false</code> otherwise
   */
  public boolean canHandle(File file);

  /**
   * Return streamable file reference. For FLV files returned streamable file already has generated
   * metadata injected.
   *
