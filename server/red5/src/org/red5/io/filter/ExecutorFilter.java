...
/**
 * A filter that forward events to {@link Executor}. You can apply various thread model by inserting
 * this filter to the {@link IoFilterChain}. This filter is usually inserted by {@link ThreadModel}
 * automatically, so you don't need to add this filter in most cases.
 *
 * <p>Please note that this filter doesn't manage the life cycle of the underlying {@link Executor}.
 * You have to destroy or stop it by yourself.
 *
 * <p><a href="mailto:dev@directory.apache.org">Apache Directory Project</a>
 *
...
public class ExecutorFilter extends IoFilterAdapter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(ExecutorFilter.class);

  /** Executes submitted runnable tasks */
  private final Executor executor;

  /**
   * Creates a new instace with the default thread pool implementation (<tt>new
   * ThreadPoolExecutor(16, 16, 60, TimeUnit.SECONDS, new LinkedBlockingQueue() )</tt>).
   */
