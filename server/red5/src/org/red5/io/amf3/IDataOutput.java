 ...
 * @see <a href="http://livedocs.adobe.com/flex/2/langref/flash/utils/IDataOutput.html">Adobe
 *     Livedocs (external)</a>
 */
public interface IDataOutput {
  ...
  /**
   * Write UTF-8 encoded string as byte array. This string is stored without informations about its
   * length, so {@link IDataInput#readUTFBytes(int)} must be used to load it.
   *
   * @param value the string
   */
