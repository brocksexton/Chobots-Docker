...
public class StuffItemLightTO extends StuffTOBase {
  ...
  public String toStringPresentation() {
    return getFileName()
        ...
        + fixNull(getPrice())
        + "|"
        + (Boolean.TRUE.equals(getHasColor()) ? "t" : "f")
        + "|"
        + fixNull(getPlacement())
        + "|"
        + (Boolean.TRUE.equals(getUsed()) ? "t" : "f")
        + "|"
        + fixNull(getX())
        + "|"
        + fixNull(getY())
        ...
        + fixNull(getRotation())
        + "|"
        + (Boolean.TRUE.equals(getGiftable()) ? "t" : "f")
        + "|"
        + fixNull(getShopName())
        + "|"
        + (Boolean.TRUE.equals(getPremium()) ? "t" : "f")
        + "|"
        + fixNull(getInfo());
  }
