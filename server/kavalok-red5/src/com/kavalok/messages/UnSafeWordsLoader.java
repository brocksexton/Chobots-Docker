...
public class UnSafeWordsLoader implements ISessionDependent {
  ...
  public void load() {
    ...
    for (BlockWord blockWord : blockWords) blockWordsValues.add(blockWord.getWord());
    ...
    for (SkipWord skipWord : skipWords) skipWordsValues.add(skipWord.getWord());
    ...
    for (ReviewWord reviewWord : reviewWords) reviewWordsValues.add(reviewWord.getWord());
