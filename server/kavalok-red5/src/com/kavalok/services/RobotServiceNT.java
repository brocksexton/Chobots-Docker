...
public class RobotServiceNT extends DataServiceNotTransactionBase {
  ...
  public List<RobotScoreTO> getTopScores() {
    ...
    List<RobotScoreTO> result = ReflectUtil.convertBeansByConstructor(robots, RobotScoreTO.class);
  ...
  public List<RobotTeamScoreTO> getTeamTopScores() {
    ...
    List<RobotTeamScoreTO> result =
        ReflectUtil.convertBeansByConstructor(robots, RobotTeamScoreTO.class);
  ...
  public ObjectMap<String, Object> getCombatData(String soId) {
    ISharedObject sharedObject = KavalokApplication.getInstance().getSharedObject(soId);
    CombatListener combat = (CombatListener) SOListener.getListener(sharedObject);
