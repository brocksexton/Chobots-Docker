...
public class ExchangeShopProcessor implements IShopProcessor {

  @SuppressWarnings("unchecked")
  @Override
  public List<StuffTypeTO> getStuffTypes(Session session, String shopName) {
    List<StuffTypeWrapper> result = new StuffTypeDAO(session).findByShopName(shopName);
  ...
  private ObjectMap<String, Object> getSKUInfo(SKU sku) {
    ...
    if (sku != null) {
      ...
      result.put("bugs", sku.getBugsBonus());
    }
    return result;
  }
