  ...
  public void run() {
    ...
    try {
      ...
      List<UserServer> userServers =
          new UserServerDAO(strategy.getSession()).getAllUserServer(server);
      ...
      logger.debug("Online users processor finish");
