...
public class Statement implements java.sql.Statement {
  ...
  public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "executing sql {0} autoGeneratedKeys {1}", sql, autoGeneratedKeys);
  ...
  public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "executeUpdate sql {0} autoGeneratedKeys {1}", sql, autoGeneratedKeys);
    return wrapper.executeUpdate(sql, autoGeneratedKeys);
  }

  public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "executeUpdate sql {0} columnIndexes {1}", sql, columnIndexes);
