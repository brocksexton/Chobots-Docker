...
public class PreparedStatement implements java.sql.PreparedStatement {
  ...
  public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "PreparedStatement.execute(String sql {0}, int autoGeneratedKeys {1})",
  ...
  public boolean execute(String sql, int[] columnIndexes) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "PreparedStatement.execute(String sql {0}, int columnIndexes {1})", sql, columnIndexes);
    return wrapper.execute(sql, columnIndexes);
  }

  public boolean execute(String sql, String[] columnNames) throws SQLException {
    ThreadMonitorServices.setJobDetails(
        "PreparedStatement.execute(String sql {0}, int columnNames {1})", sql, columnNames);
