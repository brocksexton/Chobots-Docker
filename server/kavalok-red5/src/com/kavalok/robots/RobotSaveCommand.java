...
public class RobotSaveCommand {
  ...
  public RobotSaveCommand(
      Session session, Collection<RobotSaveTO> robotsData, Collection<RobotItemSaveTO> itemsData) {
    super();
  ...
  private void saveItems() {
    for (RobotItem item : items) {
      ...
      if (item.getRobot() == null && currentRobot == null) {
        ...
        changed =
            !item.getRobot().getId().equals(currentRobot.getId())
