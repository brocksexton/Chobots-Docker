...
public class BillingTransactionUtil {
  ...
  public static Transaction setProcessingState(
      Session session,
      Long transactionId,
      Object xmlObjectRequestParams,
      String payedAmount,
      String currency)
      throws Exception {
  ...
  public static RobotTransaction setProcessingState(
      Session session,
      RobotTransaction tx,
      RobotTransactionDAO dao,
      Object xmlObjectRequestParams,
      String payedAmount,
      String currency)
      throws Exception {
  ...
  public static Transaction setWrongRequestState(Session session, Long transactionId)
      throws Exception {
    TransactionDAO dao = new TransactionDAO(session);
    Transaction trans = dao.findById(transactionId, false);
  ...
  public static RobotTransaction createRobotTransaction(
      Session session, User user, Integer skuId, String source) throws Exception {
  ...
  public static Transaction createTransaction(
    ...
    return createTransaction(
        session,
        user,
        successMessage != null ? successMessage : sku.getName(),
        sku,
        descripionObject,
        source);
  }
