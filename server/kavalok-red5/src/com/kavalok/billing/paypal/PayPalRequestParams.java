...
public class PayPalRequestParams {
  @Element private String item_number = " ";

  @Element private String residence_country = " ";

  @Element private String verify_sign = " ";

  @Element private String prefix = " ";

  @Element private String payment_status = " ";

  @Element private String business = " ";

  @Element private String payer_id = " ";

  @Element private String first_name = " ";

  @Element private String shipping = " ";

  @Element private String payer_email = " ";

  @Element private String mc_fee = " ";

  @Element private String txn_id = " ";

  @Element private String quantity = " ";

  @Element private String receiver_email = " ";

  @Element private String notify_version = " ";

  @Element private String txn_type = " ";

  @Element private String test_ipn = " ";

  @Element private String payer_status = " ";

  @Element private String mc_currency = " ";

  @Element private String mc_gross = " ";

  @Element private String custom = " ";

  @Element private String payment_date = " ";

  @Element private String charset = " ";

  @Element private String mc_gross1 = " ";

  @Element private String tax = " ";

  @Element private String item_name = " ";

  @Element private String last_name = " ";

  @Element private String payment_type = " ";

  @Element private String receiver_id = " ";
