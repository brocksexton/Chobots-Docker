...
public class GeneratePartner {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "  <a href=\"http://www.chobots.com/contact_us.html\">Chobots Support</a> |");
    System.out.println("  <a href=\"http://www.chobots.com/privacy.html\">Privacy Policy</a> | ");
    System.out.println(
        "  <a href=\"http://www.chobots.com/terms.html\">Terms and Conditions</a></font></p>");
    System.out.println("</div>");
    System.out.println("<!-- Chobots flash place end -->");
    System.out.println("");
    System.out.println("<!-- Chobots install script start -->");
    System.out.println(
        "<script src=\"http://www.chobots.com/javascripts/partner.js\" type=\"text/javascript\"></script>");
    System.out.println("<script type=\"text/javascript\">");
    System.out.println("//<![CDATA[");
    System.out.println(
        "   var _ch_p_={\"width\":\"902\", \"height\":\"512\", \"bgcolor\":\"#0066CC\", \"mppc_partner\":\""
            + parterName
    ...
    for (int i = 0; i < banners.length; i++) {
      ...
      String width =
          bannerName.substring(
              indexes.get(indexes.size() - 2) + 1, indexes.get(indexes.size() - 1));
      String height =
          bannerName.substring(indexes.get(indexes.size() - 1) + 1, bannerName.indexOf(".swf"));
      ...
      System.out.println(
          "  <param name=\"movie\" value=\"http://www.chobots.com/game/resources/banners/"
              + bannerName
              + "\"/>");
      System.out.println(
          "  <param name=\"FlashVars\" value=\"url=http://www.chobots.com/?partner="
              + parterName
              + "\">");
      System.out.println("  <embed width=\"" + width + "\" height=\"" + height + "\"");
      System.out.println(
          "    src=\"http://www.chobots.com/game/resources/banners/" + bannerName + "\"");
      System.out.println(
          "    FlashVars=\"url=http://www.chobots.com/?partner=" + parterName + "\"/>");
